...
export const TRANSLATIONS: TranslationDictionary = {
  ...
  btn_ai_summary: { en: 'Summary', ar: 'تلخيص' },
  btn_ai_quiz: { en: 'Quiz', ar: 'اختبار' },
  btn_ai_roadmap: { en: 'Roadmap', ar: 'خطة تعلم' },
  btn_ai_tags: { en: 'Tags', ar: 'وسوم' },
  btn_ai_explain: { en: 'Explain / Ask', ar: 'شرح / سؤال' },
  ai_input_placeholder: { en: 'Ask a specific question...', ar: 'اطرح سؤالاً محدداً...' },
  ...
  ai_summary_title: { en: 'UniShare AI', ar: 'UniShare AI' },
